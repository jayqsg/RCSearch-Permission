...
Narrative:
As a user
Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location can access “Company” profile.

Scenario: 148106 : Verify that user with deal sponsor,deal/ fund size and location can access company profile in my universe include
When I update TestCaseId 148106
