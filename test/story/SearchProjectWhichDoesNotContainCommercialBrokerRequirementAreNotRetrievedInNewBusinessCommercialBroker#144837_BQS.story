...
Narrative:
As a user
Perform "New Business >> Commercial Broker" search and verify that projects that does not have commercial broker requirement are not retrieved.

Scenario: TC 144837: Verify that projects which does not have commercial broker requirement selected in new business commercial broker search are not retrieved.
When I update TestCaseId 144837
When I update TestCaseName Perform "New Business >> Commercial Broker" search and verify that projects that does not have commercial broker requirement are not retrieved.
