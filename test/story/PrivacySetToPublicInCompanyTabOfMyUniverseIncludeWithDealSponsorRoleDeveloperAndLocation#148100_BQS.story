...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location can access “Company” profile.

Scenario: 148100 : Verify that only user with deal sponsor role, developer subrole and location can access company profile in my universe include
When I update TestCaseId 148100
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location can access “Company” profile.
