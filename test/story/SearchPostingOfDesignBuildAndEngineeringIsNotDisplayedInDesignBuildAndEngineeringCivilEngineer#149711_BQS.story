...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Civil Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Civil Engineer" are not retrieved.

Scenario: TC 149711 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Civil Engineer" search
When I update TestCaseId 149711
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Civil Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Civil Engineer" are not retrieved.
