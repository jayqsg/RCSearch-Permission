...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size cannot access “Posting” profile.

Scenario: 147661 : Verify that only user with deal sponsor role,developer sub role and deal fund size cannot access project when deal sponsor user is excludes in my universe
When I update TestCaseId 147661
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size cannot access “Posting” profile.
