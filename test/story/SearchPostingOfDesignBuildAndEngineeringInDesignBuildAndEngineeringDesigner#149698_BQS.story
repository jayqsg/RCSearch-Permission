...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Designer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Designer" are retrieved.

Scenario: TC 149698 : Search and Verify the postings of "Design, Build & Engineering role" role is displayed in "Design, Build & Engineering >> Designer" search
When I update TestCaseId 149698
When I update TestCaseName Perform: "Design, Build & Engineering >> Designer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Designer" are retrieved.
