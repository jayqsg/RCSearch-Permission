...
Narrative:
As a user
Create "Service >> Corporate Finance" requirement and verify that appropriate matches are displayed when "Matches" link is clicked

Scenario: TC 144826 : Create service requirement in corporate finance and verify the appropriate matches.
When I update TestCaseId 144826
When I update TestCaseName Create "Service >> Corporate Finance" requirement and verify that appropriate matches are displayed when "Matches" link is clicked
...
And I click on corporate finance option in service provider,broker,investment banker field
...
And I select corporate finance option in professional requirement field
