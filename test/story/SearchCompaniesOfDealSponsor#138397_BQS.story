...
When I update TestCaseName Perform: "Developer, Deal Sponsor >> Deal Sponsor" search Verify that companies of "Deal Sponsor" sub role are retrieved.
...
And I set value for project completed
Then I verify 'Sterling' company name is displayed in deal sponsors developers search
When I clear value for project completed
And I set value for sq ft developed
Then I verify 'Sterling' company name is displayed in deal sponsors developers search
