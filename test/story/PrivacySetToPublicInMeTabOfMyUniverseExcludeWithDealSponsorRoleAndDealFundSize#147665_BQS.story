...
Narrative:
As a user
Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size cannot access “Me” profile.

Scenario: 147665 : Verify that only deal sponsor role and deal fund size user cannot access me profile in my universe exclude
When I update TestCaseId 147665
When I update TestCaseName Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size cannot access “Me” profile.
