...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Environmental Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Environmental Engineer" are not retrieved.

Scenario: TC 150261 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Environmental Engineer" search
When I update TestCaseId 150261
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Environmental Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Environmental Engineer" are not retrieved.
