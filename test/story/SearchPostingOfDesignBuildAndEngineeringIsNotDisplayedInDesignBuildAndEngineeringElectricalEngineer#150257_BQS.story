...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Electrical Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Electrical Engineer" are not retrieved.

Scenario: TC 150257 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Electrical Engineer" search
When I update TestCaseId 150257
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Electrical Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Electrical Engineer" are not retrieved.
...
And I click on 'Electrical Engineer' link
Then I verify 'Design Build & Engineering' is displayed in find of search option
And I verify 'Electrical Engineer' is displayed in provider of search option
When I click on service drop down field
And I select lighting option in service drop down field
Then I verify 'CGary DBE Service' posting is not displayed in search result of DBE search
When I click on service drop down field
And I clear lighting option in service drop down field
And I set the value for project size field in DBE search
Then I verify 'CGary DBE Service' posting is not displayed in search result of DBE search
