...
Narrative:
As a user
I Verify that projects of other role users except Lenders can view be viewed.

Scenario: 136660 : Verify that lender users exclude from my universe are invisible when privacy is set to exclude in project tab
When I update TestCaseId 136660
When I update TestCaseName Verify that projects of other role users except Lenders can view be viewed.
