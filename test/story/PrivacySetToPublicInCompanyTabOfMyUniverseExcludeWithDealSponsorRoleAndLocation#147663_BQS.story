...
Narrative:
As a user
Select “Deal Sponsor” role + "Location" and verify that only the user with Deal sponsor role with Specified location cannot access “Company” profile.

Scenario: 147663 : Verify that only user with deal sponsor role and location cannot access company profile in my universe exclude
When I update TestCaseId 147663
When I update TestCaseName Select “Deal Sponsor” role + "Location" and verify that only the user with Deal sponsor role with Specified location cannot access “Company” profile.
