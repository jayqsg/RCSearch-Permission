...
Narrative:
As a user
Select “Deal Sponsor” role + "Location" and verify that only the user with Deal sponsor role with Specified location cannot access “Posting” profile.

Scenario: 147664 : Verify that only user with deal sponsor role and location cannot access project in my universe exclude.
When I update TestCaseId 147664
When I update TestCaseName Select “Deal Sponsor” role + "Location" and verify that only the user with Deal sponsor role with Specified location cannot access “Posting” profile.
