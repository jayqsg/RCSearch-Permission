...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Structural Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Structural Engineer" are not retrieved.

Scenario: TC 150263 :  Search and Verify the company of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Structural Engineer" search
When I update TestCaseId 150263
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Structural Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Structural Engineer" are not retrieved.
