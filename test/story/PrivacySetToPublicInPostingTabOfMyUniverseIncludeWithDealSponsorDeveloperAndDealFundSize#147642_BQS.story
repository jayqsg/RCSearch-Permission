...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size can access “Posting” profile.

Scenario: 147642 : Verify that only user with deal sponsor role and developer sub role with deal/fund size can access project when deal sponsor user is included in my universe
When I update TestCaseId 147642
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size can access “Posting” profile.
