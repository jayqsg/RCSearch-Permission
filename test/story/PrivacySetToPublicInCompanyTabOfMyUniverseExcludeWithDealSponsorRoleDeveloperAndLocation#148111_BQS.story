...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location cannot access “Company” profile.

Scenario: 148111 : Verify that only user with deal sponsor role,developer and location cannot access company profile in my universe exclude
When I update TestCaseId 148111
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location cannot access “Company” profile.
