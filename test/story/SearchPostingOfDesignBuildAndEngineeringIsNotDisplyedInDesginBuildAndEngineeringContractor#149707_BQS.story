...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Contractor" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Contractor" are not retrieved.

Scenario: TC 149707 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Contractor" search
When I update TestCaseId 149707
When I update TestCaseName Perform: "Design, Build & Engineering >> Contractor" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Contractor" are not retrieved.
