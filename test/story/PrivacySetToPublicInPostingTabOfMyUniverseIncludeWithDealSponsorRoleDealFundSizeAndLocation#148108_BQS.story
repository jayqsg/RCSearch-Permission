...
Scenario: 148108 : Verify that only user with deal sponsor role and location can access project when deal sponsor user is included in my universe
When I update TestCaseId 148108
