...
Narrative:
As a user
Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size can access “Me” profile.

Scenario: 147650 : Verify that only  user with deal sponsor role and deal/fund size access me profile in my universe include
When I update TestCaseId 147650
When I update TestCaseName Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size can access “Me” profile.
