...
Narrative:
As a user
Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location cannot access “Company” profile.

Scenario: 148114 : Verify that only user with deal sponsor role,specified deal fund size and location cannot access company profile in my universe exclude
When I update TestCaseId 148114
When I update TestCaseName Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location cannot access “Company” profile.
