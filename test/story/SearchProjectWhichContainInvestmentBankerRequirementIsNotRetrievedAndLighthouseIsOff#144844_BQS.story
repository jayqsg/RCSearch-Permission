...
Narrative:
As a user
Perform "New Business >> Investment Banker" search and verify that projects that has a investment banker requirement but Lighthouse is turned OFF are not retrieved.

Scenario: TC 144844: Verify that projects which have investment banker requirement selected in new business investment banker search are not retrieved.
When I update TestCaseId 144844
When I update TestCaseName Perform "New Business >> Investment Banker" search and verify that projects that has a investment banker requirement but Lighthouse is turned OFF are not retrieved.
