...
Narrative:
As a user
Create "Service >>Advisor" requirement and verify that appropriate matches are displayed when "Matches" link is clicked

Scenario: TC 144822 : Create service requirement in corporate finance and verify the appropriate matches.
When I update TestCaseId 144822
When I update TestCaseName Create "Service >> Advisor" requirement and verify that appropriate matches are displayed when "Matches" link is clicked
