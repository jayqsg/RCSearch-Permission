...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Architect" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Architect" are retrieved.

Scenario: TC 149694 : Search and Verify the postings of "Design, Build & Engineering role" role is displayed in "Design, Build & Engineering >> Designer" search
When I update TestCaseId 149694
When I update TestCaseName  Perform: "Design, Build & Engineering >> Architect" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Architect" are retrieved.
