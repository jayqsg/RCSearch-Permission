...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Structural Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Structural Engineer" are not retrieved.

Scenario: TC 150265 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Structural Engineer" search
When I update TestCaseId 150265
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Structural Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Structural Engineer" are not retrieved.
