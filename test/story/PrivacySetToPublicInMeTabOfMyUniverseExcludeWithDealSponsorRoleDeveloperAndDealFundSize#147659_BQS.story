...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size cannot access “Me” profile.

Scenario: 147659 : Verify that only deal sponsor developer subrole and deal fund size user cannot access me profile in my universe exclude
When I update TestCaseId 147659
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size cannot access “Me” profile.
