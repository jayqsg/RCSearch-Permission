...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Mechanical Engineer" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Mechanical Engineer" are retrieved.

Scenario: TC 149712 :  Search and Verify the company of "Design, Build & Engineering role" role in "Design, Build & Engineering >> Mechanical Engineer" search
When I update TestCaseId 149712
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Mechanical Engineer" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Mechanical Engineer" are retrieved.
