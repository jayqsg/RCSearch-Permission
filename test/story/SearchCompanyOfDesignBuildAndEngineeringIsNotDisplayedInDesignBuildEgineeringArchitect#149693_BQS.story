...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Architect" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Architect" are not retrieved.

Scenario: TC 149693 :  Search and Verify the company of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Designer" search
When I update TestCaseId 149693
When I update TestCaseName Perform: "Design, Build & Engineering >> Architect" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Architect" are not retrieved.
