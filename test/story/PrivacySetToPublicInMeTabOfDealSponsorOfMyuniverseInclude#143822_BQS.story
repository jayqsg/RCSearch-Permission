...
Narrative:
As a user
I Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Me” profile.

Scenario: 143822 : Verify that only deal sponsor user cannot access me profile in my universe exclude
When I update TestCaseId 143822
When I update TestCaseName Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Me” profile.
