...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" and verify that only the user with Deal sponsor role and Specified Sub-role cannot access “Company” profile.

Scenario: 147657 : Verify that only deal sponsor user with developer role cannot access company profile in my universe exclude
When I update TestCaseId 147657
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" and verify that only the user with Deal sponsor role and Specified Sub-role cannot access “Company” profile.
