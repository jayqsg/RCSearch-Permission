...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size cannot access “Company” profile.

Scenario: 147660 : Verify that only user with deal sponsor,developer and deal fund size cannot access company profile in my universe exclude
When I update TestCaseId 147660
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Sub-role and Deal/Fund size cannot access “Company” profile.
