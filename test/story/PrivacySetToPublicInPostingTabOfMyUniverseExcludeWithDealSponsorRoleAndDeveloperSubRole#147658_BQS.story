...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" and verify that only the user with Deal sponsor role and Specified Sub-role cannot access “Posting” profile.

Scenario: 147658 : Verify that only user with deal sponsor role and developer sub role cannot access project when deal sponsor user is excludes in my universe
When I update TestCaseId 147658
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" and verify that only the user with Deal sponsor role and Specified Sub-role cannot access “Posting” profile.
