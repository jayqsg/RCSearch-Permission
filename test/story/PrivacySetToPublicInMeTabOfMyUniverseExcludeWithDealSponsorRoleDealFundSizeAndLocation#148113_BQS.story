...
Narrative:
As a user
Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location cannot access “Me” profile.

Scenario: 148113 : Verify that only user with deal sponsor role,deal fund size and location cannot access me profile in my universe exclude
When I update TestCaseId 148113
When I update TestCaseName Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location cannot access “Me” profile.
