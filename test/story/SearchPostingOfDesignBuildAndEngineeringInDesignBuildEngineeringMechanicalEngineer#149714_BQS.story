...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Mechanical Engineer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Mechanical Engineer" are retrieved.

Scenario: 149714 : Search and Verify the postings of "Design, Build & Engineering role" role is displayed in "Design, Build & Engineering >> Mechanical Engineer" search
When I update TestCaseId 149714
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Mechanical Engineer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Mechanical Engineer" are retrieved.
...
And I click on 'Mechanical Engineer' link
Then I verify 'Design Build & Engineering' is displayed in find of search option
And I verify 'Mechanical Engineer' is displayed in provider of search option
When I set the value for project size field in DBE search
Then I verify 'CGary DBE Service' posting is displayed in search result of DBE search
...
And I select cogeneration option in service drop down field
Then I verify 'CGary DBE Service' posting is displayed in search result of DBE search
When I click on service drop down field
And I clear cogeneration option in service drop down field
