...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Designer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Designer" are not retrieved.

Scenario: TC 149699 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Designer" search
When I update TestCaseId 149699
When I update TestCaseName Perform: "Design, Build & Engineering >> Designer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Designer" are not retrieved.
