...
Narrative:
As a user
Create "Financial >> Debt >> Loan" requirement and verify that appropriate matches are displayed when "Matches" link is clicked

Scenario: TC 144812 : Create financial requirement in Financial>>Debt>>Loan and verify the appropriate matches.
When I update TestCaseId 144812
When I update TestCaseName Create "Financial >> Debt >> Loan" requirement and verify that appropriate matches are displayed when "Matches" link is clicked
...
And I select loan option in loan type field of Debt Requirement
And I click on 'Create' button in service requirement
And I click on matches
Then I should see 'Money' in find of money search
And I verify 'MSmi Loan' lender loan name is displayed when click on matches of financial requirement
