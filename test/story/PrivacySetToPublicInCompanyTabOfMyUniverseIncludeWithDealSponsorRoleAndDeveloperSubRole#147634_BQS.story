...
Narrative:
As a user
Select “Deal Sponsor” role and "Sub-Role" and verify that only the user with Deal sponsor role and Specified Sub-role can access “Company” profile.

Scenario: 147634 : Verify that only deal sponsor user cannot access company profile in my universe include
When I update TestCaseId 147634
When I update TestCaseName Select “Deal Sponsor” role and "Sub-Role" and verify that only the user with Deal sponsor role and Specified Sub-role can access “Company” profile.
