...
Narrative:
As a user
Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location cannot access “Postings” profile.

Scenario: 148115 : Verify that only user with deal sponsor role, specified deal fund size and location cannot access project in my universe exclude.
When I update TestCaseId 148115
When I update TestCaseName Select “Deal Sponsor” role + Specified "Deal/Fund Size" + "Location" and verify that only the user with Deal sponsor role with Specified Deal/Fund Size and Location cannot access “Postings” profile.
