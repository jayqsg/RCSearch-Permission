...
Narrative:
As a user
Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size can access “Posting” profile.

Scenario: 147654 : Verify that only user with deal sponsor role and with deal/fund size can access project when deal sponsor user is included in my universe
When I update TestCaseId 147654
When I update TestCaseName Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size can access “Posting” profile.
