...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Health & Safety Engineer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Health & Safety Engineer" are retrieved.

Scenario: TC 150268 : Search and Verify the postings of "Design, Build & Engineering role" role is displayed in "Design, Build & Engineering >> Health & Safety Engineer" search
When I update TestCaseId 150268
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Health & Safety Engineer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Health & Safety Engineer" are retrieved.
