...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Civil Engineer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Civil Engineer" are retrieved.

Scenario: TC 149710 : Search and Verify the postings of "Design, Build & Engineering role" role is displayed in "Design, Build & Engineering >> Civil Engineer" search
When I update TestCaseId 149710
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Civil Engineer" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Civil Engineer" are retrieved.
