...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Contractor" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Contractor" are retrieved.

Scenario: TC 149706 : Search and Verify the postings of "Design, Build & Engineering role" role is displayed in "Design, Build & Engineering >> Contractor" search
When I update TestCaseId 149706
When I update TestCaseName 	Perform: "Design, Build & Engineering >> Contractor" search and Verify that "Design, Build & Engineering Service" postings with "I am a" as "Contractor" are retrieved.
