...
Narrative:
As a user
I Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Company” profile.

Scenario: 143824 : Verify that only deal sponsor user cannot access company profile in my universe exclude
When I update TestCaseId 143824
When I update TestCaseName Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Company” profile.
