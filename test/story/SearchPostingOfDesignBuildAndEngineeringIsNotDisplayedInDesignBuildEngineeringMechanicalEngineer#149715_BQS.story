...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Mechanical Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Mechanical Engineer" are not retrieved.

Scenario: TC 149715 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Mechanical Engineer" search
When I update TestCaseId 149715
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Mechanical Engineer" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Mechanical Engineer" are not retrieved.
