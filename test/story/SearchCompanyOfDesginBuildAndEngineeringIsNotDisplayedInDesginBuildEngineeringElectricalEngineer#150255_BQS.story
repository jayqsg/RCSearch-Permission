...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Engineer >> Electrical Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Electrical Engineer" are not retrieved.

Scenario: TC 150255 :  Search and Verify the company of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Electrical Engineer" search
When I update TestCaseId 150255
When I update TestCaseName Perform: "Design, Build & Engineering >> Engineer >> Electrical Engineer" search and Verify that companies of users other than "Design, Build & Engineering" role with "We are a" as "Electrical Engineer" are not retrieved.
