...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Architect" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Architect" are not retrieved.

Scenario: TC 149695 : Search and Verify the postings of "Design, Build & Engineering role" role is not displayed in "Design, Build & Engineering >> Architect" search
When I update TestCaseId 149695
When I update TestCaseName Perform: "Design, Build & Engineering >> Architect" search and Verify that postings other than "Design, Build & Engineering Service" with "I am a" as "Architect" are not retrieved.
