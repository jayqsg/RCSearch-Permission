...
Narrative:
As a user
Perform: "Design, Build & Engineering >> Architect" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Architect" are retrieved.

Scenario: TC 149692 :  Search and Verify the company of "Design, Build & Engineering role" role in "Design, Build & Engineering >> Architect" search
When I update TestCaseId 149692
When I update TestCaseName Perform: "Design, Build & Engineering >> Architect" search and Verify that companies of "Design, Build & Engineering" role with "We are a" as "Architect" are retrieved.
...
And I click on 'Architect' link
Then I verify 'Design Build & Engineering' is displayed in find of search option
And I verify 'Architect' is displayed in provider of search option
