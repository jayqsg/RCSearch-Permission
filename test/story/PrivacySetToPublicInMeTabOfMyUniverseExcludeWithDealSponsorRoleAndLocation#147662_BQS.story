...
Narrative:
As a user
Select “Deal Sponsor” role + "Location" and verify that only the user with Deal sponsor role with Specified location cannot access “Me” profile.

Scenario: 147662 : Verify that only user with deal sponsor and location cannot access me profile in my universe exclude
When I update TestCaseId 147662
When I update TestCaseName Select “Deal Sponsor” role + "Location" and verify that only the user with Deal sponsor role with Specified location cannot access “Me” profile.
