...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location can access “Me” profile.

Scenario: 148098 : Verify that only user with deal sponsor,developer subrole and location can access me profile in my universe include
When I update TestCaseId 148098
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location can access “Me” profile.
