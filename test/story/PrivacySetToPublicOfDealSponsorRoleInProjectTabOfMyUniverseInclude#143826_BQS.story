...
Narrative:
As a user
I Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Project” profile.

Scenario: 143826 : Verify that only deal sponsor user can access project when deal sponsor user is included in my universe
When I update TestCaseId 143826
When I update TestCaseName Select “Deal Sponsor” role and verify that only the user with Deal sponsor role can access “Project” profile.
