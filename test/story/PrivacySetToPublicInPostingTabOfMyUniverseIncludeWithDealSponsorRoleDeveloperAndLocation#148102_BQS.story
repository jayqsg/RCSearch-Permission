...
Narrative:
As a user
Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location can access "Posting” profile.

Scenario: 148102 : Verify that only user with deal sponsor,developer subrole and location can access project when deal sponsor user is included in my universe
When I update TestCaseId 148102
When I update TestCaseName Select “Deal Sponsor” role + "Sub-Role" + "Location" and verify that only the user with Deal sponsor role with Specified Sub-role and Location can access "Posting” profile.
