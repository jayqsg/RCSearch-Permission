...
Narrative:
As a user
Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size cannot access “Company” profile.

Scenario: 147666 : Verify that only user with deal sponsor and deal fund size cannot access company profile in my universe exclude
When I update TestCaseId 147666
When I update TestCaseName Select “Deal Sponsor” role + "Deal/Fund Size" and verify that only the user with Deal sponsor role with Specified Deal/Fund size cannot access “Company” profile.
